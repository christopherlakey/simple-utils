...
public class EnhancedXMLStreamReader implements XMLStreamReader {

    protected XMLStreamReader reader;
    private int depth;

    public EnhancedXMLStreamReader(XMLStreamReader r) {
        this.reader = r;
    }

    public static EnhancedXMLStreamReader enhance(XMLStreamReader r) {
        return (r instanceof EnhancedXMLStreamReader) ? (EnhancedXMLStreamReader) r
                : new EnhancedXMLStreamReader(r);
    }
